...
# att custom components
rm -r $OCS_WEBCONSOLE_DIR/ocsreports/require/components
cp -r /tmp/OCSNG_UNIX_SERVER_2.8/ocsreports/require/components /usr/share/ocsinventory-reports/ocsreports/require/components
